class Sycamore {
  ...
  bottomBranches() {
    ...
    line(branch1.x, branch1.y, branch1.z, this.branch1.x - this.origin.x, this.branch1.y - this.origin.y, this.branch1.z - this.origin.z);
    line(branch2.x, branch2.y, branch2.z, this.branch2.x - this.origin.x, this.branch2.y - this.origin.y, this.branch2.z - this.origin.z);
    pop();
  }
  ...
  middleBranches() {
    ...
    line(branch3.x, branch3.y, branch3.z, this.branch3.x - this.trunk1.x, this.branch3.y - this.trunk1.y, this.branch3.z - this.trunk1.z);
    line(branch4.x, branch4.y, branch4.z, this.branch4.x - this.trunk1.x, this.branch4.y - this.trunk1.y, this.branch4.z - this.trunk1.z);
    pop();
  }
  ...
  topBranch() {
    ...
    line(branch5.x, branch5.y, branch5.z, this.branch5.x - this.trunk2.x, this.branch5.y - this.trunk2.y, this.branch5.z - this.trunk2.z);
    pop();
  }
